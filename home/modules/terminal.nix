...
# STARSHIP
  programs.starship = {
    ...
    settings = {
      ...
      directory = {
        format = "[ ](base01)[$path ](bg:base01)[](fg:blue bg:base01)[](bg:blue)[](blue)";
        truncation_length = 3;
        truncate_to_repo = false;
        truncation_symbol = "…/";
      };
      git_status = {
        format = "[ ](base01)[$all_status](bg:base01)[$ahead_behind ](bg:base01 fg:red)";
      };
      git_state = {
        format = "[$state ($progress_current of $progress_total) ](bg:base01)";
      };
      git_branch = {
        symbol = "";
        format = "[$branch ](bg:base01)[](fg:cyan bg:base01)[$symbol](bg:cyan)[](cyan)";
      };
      cmd_duration = {
        min_time = 1;
        format = "[ ](base01)[$duration ](bg:base01)[](fg:purple bg:base01)[󰚭](bg:purple)[](purple)";
      };
      jobs = {
        symbol = "";
      };
